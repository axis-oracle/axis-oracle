...
import { 
  ...
  Code, Shield, Database, Clock, Server, ExternalLink, Copy, Check
} from 'lucide-react';
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            <button
              ...
              className="flex items-center gap-3 px-4 py-3 rounded-full bg-background/80 backdrop-blur-sm border border-border hover:bg-background/90 transition-colors group"
            >
              <span className="text-sm text-muted-foreground font-medium whitespace-nowrap">$AXIS CA:</span>
              <code className="text-xs sm:text-sm font-mono text-foreground break-all">
                {AXIS_CONTRACT_ADDRESS}
              </code>
              {copied ? (
