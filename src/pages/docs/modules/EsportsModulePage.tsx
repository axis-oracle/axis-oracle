...
import { Gamepad2, Clock, Shield, AlertTriangle, CheckCircle2, Trophy } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <h1 className="text-4xl font-bold tracking-tight mb-4">Esports & Sports Module</h1>
        <p className="text-lg text-muted-foreground leading-relaxed">
          Oracle modules for competitive gaming and traditional sports. Settlement is event-based, 
          triggered when matches conclude.
        </p>
      </div>
    ...
    break;
      ...
      <div className="space-y-4 pt-8 border-t border-border">
        <h2 className="text-2xl font-semibold flex items-center gap-2">
          ...
          Traditional Sports Module
        </h2>
        
        <p className="text-muted-foreground">
          Create oracles for traditional sports matches including football (soccer), basketball, 
          American football, and more. Data sourced from The Odds API.
        </p>

        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 rounded-lg border border-border bg-muted/10">
            <h4 className="font-medium mb-2">Supported Leagues</h4>
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>• <strong>Soccer:</strong> EPL, La Liga, Serie A, Bundesliga</li>
              <li>• <strong>Basketball:</strong> NBA, EuroLeague</li>
              <li>• <strong>American Football:</strong> NFL, NCAA</li>
              <li>• <strong>Baseball:</strong> MLB</li>
              <li>• <strong>Hockey:</strong> NHL</li>
            </ul>
          </div>
          <div className="p-4 rounded-lg border border-border bg-muted/10">
            <h4 className="font-medium mb-2">Data Source</h4>
            <p className="text-sm text-muted-foreground">
              <a href="https://the-odds-api.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">The Odds API</a> — 
              Real-time sports data and results
            </p>
          </div>
        </div>

        <Callout type="info">
          Sports oracles use the same event-based settlement as esports. The watcher service 
          polls for match completion and triggers automatic settlement.
        </Callout>
      </div>

      {/* Best Practices */}
      <div className="p-6 rounded-xl border border-border bg-muted/20">
        <h2 className="text-xl font-semibold mb-4">Best Practices for Gaming DApps</h2>
