...
5oPrhqL38zvCDoKgN56UmLNem526RE5CM1hzt6HoJwot`}
      ...
      <section id="modules" className="space-y-4">
        <h2 className="text-2xl font-bold flex items-center gap-2 text-foreground">
          ...
          3. Data Modules (16 Total)
        </h2>

        <p className="text-muted-foreground">
          AXIS supports 16 data modules organized into categories. Each module has its own data source, 
          settlement logic, and oracle job definition.
        </p>
        ...
        <div className="overflow-x-auto mt-6">
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-border">
                <th className="text-left p-3 text-foreground">Category</th>
                <th className="text-left p-3 text-foreground">Modules</th>
                <th className="text-left p-3 text-foreground">Data Source</th>
                <th className="text-left p-3 text-foreground">Settlement</th>
              </tr>
            </thead>
            <tbody className="text-muted-foreground">
              <tr className="border-b border-border/50">
                <td className="p-3 font-medium">Crypto</td>
                <td className="p-3">Global Crypto, Token Analytics (Memecoins)</td>
                <td className="p-3">GeckoTerminal, DexScreener</td>
                <td className="p-3">Automatic</td>
              </tr>
              <tr className="border-b border-border/50">
                <td className="p-3 font-medium">Gaming</td>
                <td className="p-3">Esports, Sports, Steam</td>
                <td className="p-3">PandaScore, Odds API, Steam API</td>
                <td className="p-3">Event-based</td>
              </tr>
              <tr className="border-b border-border/50">
                <td className="p-3 font-medium">RWA</td>
                <td className="p-3">Weather, Cosmos (Space)</td>
                <td className="p-3">Open-Meteo, Space Launch APIs</td>
                <td className="p-3">Automatic</td>
              </tr>
              <tr className="border-b border-border/50">
                <td className="p-3 font-medium">Social</td>
                <td className="p-3">Social (X/Twitter), Movies, Launchpad</td>
                <td className="p-3">Twitter API, TMDB, Pump.fun</td>
                <td className="p-3">Automatic/Early</td>
              </tr>
              <tr className="border-b border-border/50">
                <td className="p-3 font-medium text-amber-500">AI-Powered (Beta)</td>
                <td className="p-3">Politics, Economy, Awards, Legal, Custom</td>
                <td className="p-3">Claude AI</td>
                <td className="p-3">AI Resolution</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['BTC', 'ETH', 'SOL', 'BNB', 'XRP', 'ADA', 'DOGE', 'AVAX', 'DOT', 'MATIC'].map(asset => (
        ...
        {/* AI-Powered Modules */}
        <div className="bg-card/50 rounded-lg p-6 border border-amber-500/30 mt-6">
          <div className="flex items-center gap-2 mb-3">
            <h3 className="text-xl font-semibold text-amber-500">3.5 AI-Powered Modules</h3>
            <Badge variant="outline" className="text-amber-500 border-amber-500/50">BETA</Badge>
          </div>
          <p className="text-muted-foreground mb-4">
            Modules powered by Claude AI for resolving complex events that cannot be determined by traditional APIs.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            <div className="p-3 rounded border border-border/50 bg-background/50">
              <p className="font-medium">Politics</p>
              <p className="text-xs text-muted-foreground">Elections, legislation</p>
            </div>
            <div className="p-3 rounded border border-border/50 bg-background/50">
              <p className="font-medium">Economy</p>
              <p className="text-xs text-muted-foreground">Fed rates, CPI, GDP</p>
            </div>
            <div className="p-3 rounded border border-border/50 bg-background/50">
              <p className="font-medium">Awards</p>
              <p className="text-xs text-muted-foreground">Oscars, Grammys, Nobel</p>
            </div>
            <div className="p-3 rounded border border-border/50 bg-background/50">
              <p className="font-medium">Legal</p>
              <p className="text-xs text-muted-foreground">Court cases, SEC actions</p>
            </div>
            <div className="p-3 rounded border border-border/50 bg-background/50">
              <p className="font-medium">Custom</p>
              <p className="text-xs text-muted-foreground">Any question with public data</p>
            </div>
          </div>
        </div>
      </section>
