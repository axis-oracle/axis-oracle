...
// ============================================
// FEE CONFIGURATION (in $AXIS tokens)
// ============================================
export const AXIS_TOKEN_MINT = new PublicKey(
  "AwzfqJMb9SQ9zPyfVQAFTtG5ePiWfB7ZDjM6fbDTpump"
);
export const AXIS_TOKEN_DECIMALS = 6; // Standard SPL token decimals
export const CREATION_FEE_AXIS = 100_000; // 100,000 $AXIS tokens
export const CREATION_FEE_AXIS_RAW = CREATION_FEE_AXIS * Math.pow(10, AXIS_TOKEN_DECIMALS); // Raw amount with decimals
