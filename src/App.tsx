...
import SocialMediaPage from "./pages/docs/modules/SocialMediaPage";
import AIModulesPage from "./pages/docs/modules/AIModulesPage";
        ...
        <TooltipProvider>
          ...
          <Routes>
            ...
            <Route path="/docs" element={<DocsLayout />}>
              ...
              <Route path="modules/social-media" element={<SocialMediaPage />} />
              <Route path="modules/ai-modules" element={<AIModulesPage />} />
