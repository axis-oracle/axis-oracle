...
import { CalendarIcon, Loader2, CheckCircle, XCircle, AlertCircle, Clock, Info, ChevronDown } from 'lucide-react';
...
const MIN_MARKET_CAP = 100_000; // $100k minimum
...
export const MemecoinModule: FC<MemecoinModuleProps> = ({ onCreateFeed, isLoading, deploymentState, getButtonText }) => {
  ...
  // Fetch token data when address or chain changes
  useEffect(() => {
  ...
  return (
    <ModuleCard
      ...
      description="Multi-chain tracking for memecoins & tokens"
      index={1}
    >
