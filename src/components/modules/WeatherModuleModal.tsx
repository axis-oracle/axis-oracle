...
interface WeatherModuleModalProps {
  open: boolean;
...
export const WeatherModuleModal: FC<WeatherModuleModalProps> = ({ 
  open, 
  onOpenChange, 
  onCreateFeed, 
  isLoading, 
      ...
      <DialogContent className="sm:max-w-[480px] bg-card border-border">
        <DialogHeader>
          <div className="flex items-center gap-3">
            <img src={weatherIcon} alt="Weather" className="h-10 w-10 object-contain" />
            <div>
              <DialogTitle className="text-xl font-bold">Weather</DialogTitle>
              <p className="text-sm text-muted-foreground">Hyper-local meteorological feeds for on-chain settlements</p>
            </div>
          </div>
        </DialogHeader>
