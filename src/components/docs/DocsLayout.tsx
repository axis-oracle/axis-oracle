...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Esports & Sports', href: '/docs/modules/esports' },
      { title: 'Weather & RWA', href: '/docs/modules/weather-sports' },
      { title: 'Social & Media', href: '/docs/modules/social-media' },
      { title: 'AI Modules (Beta)', href: '/docs/modules/ai-modules' },
    ],
  },
  {
