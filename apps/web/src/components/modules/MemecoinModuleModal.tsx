...
export const MemecoinModuleModal: FC<MemecoinModuleModalProps> = ({ 
  ...
  const handleConfirmedCreate = () => {
    ...
    onCreateFeed({
      ...
      // Add token data for better card display
      ...
      <DialogContent className="sm:max-w-[480px] bg-card border-border">
        <DialogHeader>
          <div className="flex items-center gap-3">
            <img src={pepeIcon} alt="Memecoins" className="h-10 w-10 object-contain" />
            <div>
              <DialogTitle className="text-xl font-bold">Memecoins</DialogTitle>
              <p className="text-sm text-muted-foreground">Comprehensive tracking for the Solana memecoins</p>
            </div>
          </div>
        </DialogHeader>
